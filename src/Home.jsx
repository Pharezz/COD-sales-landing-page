      ...
      {config.hero.enabled && (
        <section id="hero" className="bg-gray-50">
          <div className="flex flex-col items-center space-y-7 section pt-30 px-4 md:px-0">
            ...
            <img
              src={getImage(config.hero.images.product)}
              alt="product image"
              className="w-"
            />
            <div className="bg-primary text-center text-white py-5 w-full">
              <p className="text-3xl">
                <span className="font-bold">
                  {config.hero.sold_text.split(" To")[0]}
                </span>{" "}
                To
                <span className="font-bold">
                  {config.hero.sold_text.split(" To")[1]}
                </span>
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-10">
              <img
                src={getImage(config.hero.images.whatsapp1)}
                alt="whatsapp screenshot"
                className="w-full h-full"
              />
              <img
                src={getImage(config.hero.images.whatsapp2)}
                alt="whatsapp screenshot"
                className="w-full h-full"
              />
            </div>
        ...
        <section id="product">
          <div className="flex flex-col items-center space-y-5 section px-4 md:px-0">
            ...
            <div className="flex flex-col md:flex-row items-center gap-10 mt-20 mb-10">
              <img
                src={getImage(config.product.images.black_watch)}
                alt="product image"
                className="w-80"
              />
            </div>
      ...
      {config.offer.enabled && (
        <section id="offer">
          ...
          >
            ...
            <p className="text-white">{config.offer.description2}</p>
            <img
              src={getImage(config.offer.images.gift)}
              className="w-fit"
              alt="free gift img"
            />
          </div>
        ...
        <section className="bg-gray-50">
          <div className="flex flex-col items-center space-y-5 section px-4 md:px-0">
            <h1 className="text-3xl font-semibold text-gray-700">
              {config.how_it_works.title}
            </h1>
            <p className="text-gray-500 text-center">
              {config.how_it_works.description}
            </p>
        ...
        <section className="bg-gray-50">
          <div className="flex flex-col items-center space-y-5 section px-4 md:px-0">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10 items-center mb-20">
              ...
              <img
                src={getImage(config.more_features.image)}
                alt="Product Image"
        ...
        <section id="buy-offer">
          <div className="flex flex-col items-center space-y-1 section px-4 md:px-0">
            ...
            <div className="bg-black space-y-2 py-5 px-8 w-full">
              ...
              <img
                src={getImage(config.buy_offer.black_offer.image)}
              ...
              <p className="text-white text-center text-3xl font-semibold">
                ...
                <span className="line-through">
                  {config.buy_offer.black_offer.old_price}
                </span>
              </p>
              <p className="text-white text-center text-3xl font-semibold">
              ...
              <p className="text-white text-center text-3xl font-semibold">
                Delivery Fee: {config.buy_offer.black_offer.Delivery_Fee}
              </p>
              <p className="text-white text-center text-3xl font-semibold">
            ...
            <div className="bg-black space-y-2 py-5 px-8 w-full mt-10">
              ...
              <p className="text-white text-center text-3xl font-semibold">
                Old Price:{" "}
                <span className="line-through">
                  {config.buy_offer.bundle_offer.old_price}
                </span>
              </p>
              <p className="text-white text-center text-3xl font-semibold">
                ...
                {config.footer.social_links.map((link, index) => {
                  ...
                  return (
                    <a
                      ...
                      className="bg-primary text-white p-2 rounded-full h-12 w-12 items-center justify-center flex hover:-translate-y-1 duration-300 transition-transform ease-in-out"
                    >
                      {Icon && <Icon />}
                    </a>
                  );
